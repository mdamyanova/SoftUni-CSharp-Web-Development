namespace CarDealer.Web.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public async Task<IActionResult> EnableAuthenticator(EnableAuthenticatorModel model)
        {
            ...
            _logger.LogInformation("User with ID {UserId} has enabled 2FA with an authenticator Web.", user.Id);
        ...
        public async Task<IActionResult> ResetAuthenticator()
        {
            ...
            await _userManager.ResetAuthenticatorKeyAsync(user);
            _logger.LogInformation("User with id '{UserId}' has reset their authentication Web key.", user.Id);
