namespace SoftUni.Data
{
    ...
    public partial class SoftUniEntities : DbContext
    {
        ...
        public void GetProjectsByName(string firstName, string lastName)
        {
            var ctx = new SoftUniEntities();
            
            var query = "EXEC usp_GetProjects {0}, {1}";
            var sqlQuery = ctx.Database.SqlQuery<Project>(query, firstName, lastName).ToList();
            foreach (var project in sqlQuery)
            {
